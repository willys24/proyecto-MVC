...
.i18.en={translator:"Troex Nevelin &lt;troex@fury.scancode.ru&gt;",language:"English",direction:"ltr",dateFormat:"M d, Y h:i A",fancyDateFormat:"$1 h:i A",messages   : {

			/********************************** errors **********************************/
			'error'                : 'Error',
			'errUnknown'           : 'Error desconocido.',
			'errUnknownCmd'        : 'Comando desconocido.',
			'errJqui'              : 'Configuracion no valida de jQuery UI. deben estar incluidos los componentes selectable, draggable y droppable.',
			'errNode'              : 'elFinder necesita crear elementos DOM.',
			'errURL'               : 'Configuracion no valida de elFinder! La opcion URL no esta configurada.',
			'errAccess'            : 'Acceso denegado.',
			'errConnect'           : 'No se ha podido conectar con el backend.',
			'errAbort'             : 'Conexion cancelada.',
			'errTimeout'           : 'Conexion cancelada por timeout.',
			'errNotFound'          : 'Backend no encontrado.',
			'errResponse'          : 'Respuesta no valida del backend.',
			'errConf'              : 'Configuracion no valida del backend .',
			'errJSON'              : 'El modulo PHP JSON no esta instalado.',
			'errNoVolumes'         : 'No hay disponibles volumenes legibles.',
			'errCmdParams'         : 'Parametros no validos para el comando "$1".',
			'errDataNotJSON'       : 'los datos no estñan en formato JSON.',
			'errDataEmpty'         : 'No hay datos.',
			'errCmdReq'            : 'La peticion del backend necesita un nombre de comando.',
			...
			'errLocked'            : '"$1" esta bloqueado y no puede ser renombrado, movido o borrado.',
			'errExists'            : 'Ya existe un archivo llamado "$1".',
			'errInvName'           : 'Nombre de archivo no valido.',
			...
			'errMaxSize'           : 'El tamaño de los datos excede el maximo permitido.',
			'errFileMaxSize'       : 'El tamaño del archivo excede el maximo permitido.',
			...
			'errArcMaxSize'        : 'El tamaño del archivo excede el maximo permitido.',
			...
			/********************************** messages **********************************/
			'confirmReq'      : 'Se necesita confirmacion',
			'confirmRm'       : '¿Esta seguro de querer eliminar archivos?<br/>Esto no tiene vuelta atras!',
			...
			'selectlfile'     : 'Seleccionar ultimo archivo',
			...
			'no'              : 'no',
			'link'            : 'Enlace',
			'searcresult'     : 'Resultados de la busqueda',  
			...
			'ver'             : 'Version',
			'protocol'        : 'version del protocolo',
			'homepage'        : 'Project home',
			'docs'            : 'Documentacion',
			'github'          : 'Fork us on Github',
			'twitter'         : 'Siguenos en Twitter',
			'facebook'        : 'Unete a nostros en Facebook',
			'team'            : 'Equipo',
			...
			'dropFiles'       : 'Arrastre archivos aqui',
			'or'              : 'o',
			'selectForUpload' : 'Seleccione archivos para subir',
			'moveFiles'       : 'Mover archivos',
			'copyFiles'       : 'Copiar archivos',
			'rmFromPlaces'    : 'Remove from places',
			'untitled folder' : 'carpeta sin titulo',
			'untitled archivo.txt' : 'archivo.txt sin titulo',
			...
			'kindMsPP'        : 'Presentacion Microsoft Powerpoint',
			'kindOO'          : 'Documento Open Office',
			'kindAppFlash'    : 'Aplicacion Flash',
			...
			'kindJS'          : 'Codigo Javascript',
			'kindRTF'         : 'Documento RTF',
			'kindC'           : 'C source',
			'kindCHeader'     : 'Codigo C header',
			'kindCPP'         : 'Codigo C++',
			'kindCPPHeader'   : 'Codigo C++ header',
			'kindShell'       : 'Script Unix shell',
			'kindPython'      : 'Codigo Python',
			'kindJava'        : 'Codigo Java',
			'kindRuby'        : 'Codigo Ruby',
			'kindPerl'        : 'Codigo Perl',
			'kindSQL'         : 'SCodigo QL',
			'kindXML'         : 'Documento XML',
			'kindAWK'         : 'Codigo AWK source',
			...
			'kindVideoDV'     : 'Pelicula DV',
			'kindVideoMPEG'   : 'Pelicula MPEG',
			'kindVideoMPEG4'  : 'Pelicula MPEG-4',
			'kindVideoAVI'    : 'Pelicula AVI',
			'kindVideoMOV'    : 'Pelicula Quick Time',
			'kindVideoWM'     : 'Pelicula Windows Media',
			'kindVideoFlash'  : 'Pelicula Flash',
			'kindVideoMKV'    : 'Pelicula Matroska MKV',
			'kindVideoOGG'    : 'Pelicula Ogge'
		}}),a.fn.elfinderbutton=
