        ...
        function createMonthHTML(d) {
            ...
            for (var week = 0; week < 6; week++) {
                ...
                for (var day = 0; day < 7; day++) {
                    ...
                    html.push('<td data-day="' + moment(today.time).format('YYYY-MM-DD') + '" ' + attributesCallbacks({}, opt.dayTdAttrs, today) + '><div ' + attributesCallbacks(todayDivAttr, opt.dayDivAttrs, today) + '>' + showDayHTML(today.time, today.day) + '</div></td>');
                }
                html.push('</tr>');
            }
            return html.join('');
